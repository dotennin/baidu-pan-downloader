...
!function(e) {
    ...
    var _types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1), _gmInterface_gmInterface__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9), _ItemProxy__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(28), _store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8), _modules_downloadModule__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6), _modules_interfaceModule__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7), InstanceForSystem = {
    ...
    var r = n(14), a = n.n(r), o = n(16), i = n(15), l = n(1), u = n(12), c = n(9), s = n(21);
    function f(e) {
    ...
    function p(e) {
        ...
        return r.percentCount = 0, r.speedOverlay = 0, new Promise((function(e, o) {
            var i;
            r.request = c.a.download({
                url: t,
                name: (i = n, i + (d.includes(Object(s.b)(i)) ? ".__________重命名我.zip" : "")),
                saveAs: !0,
                headers: {
                ...
                onload: function() {
                    ...
                    r.status = l.b.completed, c.a.notification({
                        text: "下载完成",
                        title: n,
                        highlight: !0
                    }), e();
                ...
                onerror: function(e) {
                    ...
                    r.status = l.b.error, 0 === Object.keys(e).length ? o(new Error("user is not authorized, hitcode:122")) : o(new Error(e.error));
                }
            });
            var u = 0;
            r.intervalId = window.setInterval((function() {
                if (a) {
                    var e = a.loaded - u;
                    u = a.loaded, r.speedOverlay = e;
                }
            }), 1e3);
        }));
    }
    var g = n(18), h = n(7), m = n(2), b = {
        downloadItems: {},
        processing: 0
    }, v = Object(u.b)({
        name: "download",
            ...
            var t = Object(o.a)(a.a.mark((function t(n, r) {
                ...
                return a.a.wrap((function(t) {
                    for (;;) switch (t.prev = t.next) {
                      case 0:
                        if (t.prev = 0, o = e.progress, Object(g.a)(r())) {
                            t.next = 6;
                            break;
                        }
                      ...
                      case 6:
                        return n(v.actions.requestDownload()), t.next = 9, f(e.path);

                      case 9:
                        return i = t.sent, e.url = i.response.urls[0].url + "&filename=" + encodeURIComponent(e.serverFilename), 
                        o.status = l.b.downloading, t.next = 14, p(e);

                      case 14:
                        n(v.actions.successDownload()), n(y()), t.next = 23;
                        break;

                      case 18:
                        t.prev = 18, t.t0 = t.catch(0), n(v.actions.failureDownload()), n(h.a.actions.setError(t.t0)), 
                        n(y());
    ...
    function T(e, t) {
        ...
        return t.h.O || y("ES5").S(t, e, a), a ? (n[q].P && (E(t), r(4)), o(e) && (e = C(t, e), 
        t.l || j(t, e)), t.u && y("Patches").M(n[q], e, t.u, t.s)) : e = C(t, n, []), E(t), 
                    ...
                    if (t && "object" == typeof t) {
                        ...
                        if (n) {
                            ...
                            if (4 === c) i(o, (function(t) {
                                t !== q && (void 0 !== a[t] || u(a, t) ? l[t] || e(o[t]) : (l[t] = !0, N(n)));
                            })), i(a, (function(e) {
    ...
    L), H = U ? Symbol("immer-draftable") : "__$immer_draftable", q = U ? Symbol("immer-state") : "__$immer_state", K = ("undefined" != typeof Symbol && Symbol.iterator, 
    ...
    "use strict";
    var r = n(4), a = n(0), o = n.n(a), i = n(15), l = n(3), u = n(2), c = n(1), s = n(7), f = n(6), d = n(18), p = Object(l.b)((function(e) {
        return {
    ...
    var b = r.b.div.withConfig({
        displayName: "Modal__Wrapper",
        componentId: "ufr2n-0"
    })([ "background:transparent;" ]);
    function v(e) {
        var t = e.closeButton, n = e.open, r = e.close, a = e.children, i = e.header, l = m(e, [ "closeButton", "open", "close", "children", "header" ]), u = function() {
            "function" == typeof r && r();
        };
        return o.a.createElement(b, Object.assign({
    ...
    var P = r.b.div.attrs((function(e) {
        return {
        ...
        return Object(w.a)(n, [ {
            key: "render",
            value: function() {
                return o.a.createElement(P, this.props);
            }
        } ]), n;
    }(a.Component), I = r.b.div.attrs((function(e) {
        return {
            placeholder: e.placeholder
        };
    })).withConfig({
        displayName: "TabContainer"
    })([ "box-sizing:border-box;border:1px solid #e0e0e0;border-radius:8px 0 8px 0;overflow-x:hidden;" ]), N = r.b.span.withConfig({
        displayName: "ButtonText"
    })([ "font-size:14px;font-weight:normal;font-style:normal;font-stretch:normal;line-height:1.43;letter-spacing:0.5px;max-width:100%;" ]), A = Object(r.b)(N).withConfig({
        displayName: "_StyledButtonText"
    })([ "color:", ";" ], (function(e) {
        return e._css;
    })), D = r.b.div.attrs((function(e) {
        return {
            placeholder: e.placeholder
        };
    })).withConfig({
        displayName: "TabNavigation"
    })([ "display:flex;flex-direction:row;" ]), M = r.b.div.attrs((function(e) {
        return {
            active: e.active
        };
    })).withConfig({
        ...
        return 100 * e.tabs;
    })), z = r.b.div.withConfig({
        displayName: "TabWrapper"
    })([ "overflow-y:auto;flex:1;" ]), L = function(e) {
        x(n, e);
        var t = C(n);
        function n() {
            return Object(y.a)(this, n), t.apply(this, arguments);
        ...
        return Object(w.a)(n, [ {
            key: "render",
            value: function() {
                var e = this.props, t = e.children, n = e.onChange, r = e.activeTab, a = m(e, [ "children", "onChange", "activeTab" ]);
                return o.a.createElement(I, Object.assign({
                    className: "tabContainer"
                }, a), o.a.createElement(D, {
                    className: "tabNav"
                }, t.map((function(e, t) {
                    return e ? o.a.createElement(M, {
    ...
    })), B = n(5), $ = Object(r.b)(j).withConfig({
        displayName: "_StyledTab"
    })([ "max-height:calc(60vh - 58px);overflow:auto;" ]), V = function(e) {
        var t = e.children, n = e.name, r = m(e, [ "children", "name" ]);
        return o.a.createElement($, Object.assign({
            name: n
    ...
    var H = Object(l.b)((function(e) {
        return {
            fsIdList: Object(B.a)((function(e) {
    ...
    var G = Object(l.b)((function(e) {
        ...
        var t = e.downloadModalOpen, n = Object(l.c)(), r = h(Object(a.useState)(0), 2), i = r[0], u = r[1];
        return o.a.createElement(v, {
            open: t,
            close: function() {
    ...
    var te = Object(l.b)((function(e) {
        ...
        return o.a.createElement(J, null, o.a.createElement(v, {
            open: t,
            close: a
        }, o.a.createElement(Z, {
            action: "#"
        ...
        }, "下载设置"), o.a.createElement(ee, null, "如果下载经常出错，建议将下载数设置为1")), o.a.createElement(X, null, o.a.createElement("label", {
            htmlFor: "auto-start"
            ...
            tabIndex: 1,
            onChange: i
        }))), o.a.createElement(X, null, o.a.createElement("legend", null, "最大同时下载数"), o.a.createElement("div", null, o.a.createElement("select", {
            defaultValue: r,
            id: "max-download-count",
            className: "field select medium",
            tabIndex: 2,
            onChange: l
        }, Object(Y.a)(Array(u.a.maxDownloadCount).keys()).map((function(e) {
            return ++e;
        })).map((function(e, t) {
    ...
    window.onunload = function() {
        ne.a.setValue(c.c.items, Object.values(u.a.allDownloads)), u.a.stopAll();
    }, window.onbeforeunload = function(e) {
        var t = re.a.getState().download.downloadItems;
    ...
    var oe = Object(r.a)(ae()), ie = n(19), le = function(e) {
        ...
        function n(e) {
            var r;
            return Object(y.a)(this, n), (r = t.call(this, e)).state = {
                error: null,
                errorInfo: null
            }, r.reRenderApp = r.reRenderApp.bind(O(r)), r;
        }
        return Object(w.a)(n, [ {
            ...
            value: function() {
                this.setState({
                    error: null,
                    errorInfo: null
                }), re.a.dispatch(s.a.actions.setError(void 0));
            }
        }, {
            key: "render",
            value: function() {
                ...
                if (e) {
                    var t, n = e.toString() + (this.state.errorInfo && ie.a ? '<details style="white-space: pre-wrap">'.concat(null === (t = this.state.errorInfo) || void 0 === t ? void 0 : t.componentStack, "</details>") : "");
    ...
    }(o.a.Component), ue = Object(l.b)((function(e) {
        return {
            error: e.interface.error
        };
    }))(le), ce = Object(r.b)("div").withConfig({
        displayName: "_StyledDiv"
    })([ "display:none;" ]);
    t.a = function() {
        return o.a.createElement(o.a.Fragment, null, o.a.createElement(ce, null, "Todo Don’t know the reason. Once delete this element, Styled-components will not load properly."), o.a.createElement(oe, null), o.a.createElement(ue, null, o.a.createElement(G, null), o.a.createElement(te, null), o.a.createElement(p, null)));
    };
}, function(e, t, n) {
    "use strict";
    ...
    t.a = function(e) {
        ...
        function u(e, n) {
            ...
            var f = function e(n, l, u, f, d) {
                for (var p, g, h, y, k, x = 0, E = 0, _ = 0, S = 0, I = 0, A = 0, M = h = p = 0, R = 0, z = 0, L = 0, F = 0, U = u.length, W = U - 1, B = "", $ = "", V = "", H = ""; R < U; ) {
                ...
                if (0 < (F = $.length)) {
                    if (z = l, 0 < N && (void 0 !== (k = i(2, $, z, n, T, O, F, f, d, f)) && 0 === ($ = k).length)) return H + $ + V;
                    if ($ = z.join(",") + "{" + $ + "}", 0 != P * C) {
    ...
    "use strict";
    n.r(t), function(e) {
        var t = n(14), r = n.n(t), a = n(16), o = n(0), i = n.n(o), l = n(23), u = n.n(l), c = n(26), s = n(19), f = n(21), d = n(3), p = n(8), g = n(29);
        function h(e) {
    ...
    var B = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/, $ = Object.prototype.hasOwnProperty, V = {}, H = {};
    ...
    function X(e, t, n, r) {
        ...
        (null !== a ? 0 === a.type : !r && (2 < t.length && ("o" === t[0] || "O" === t[0]) && ("n" === t[1] || "N" === t[1]))) || (function(e, t, n, r) {
            ...
            return !!$.call(H, e) || !$.call(V, e) && (B.test(e) ? H[e] = !0 : (V[e] = !0, !1));
    ...
    var Vt = o.unstable_UserBlockingPriority, Ht = o.unstable_runWithPriority, qt = !0;
    function Kt(e, t) {
        Qt(t, e, !1);
    }
    function Qt(e, t, n) {
    ...
    function Xt(e, t, n, r) {
        if (qt) if (0 < yt.length && -1 < Ot.indexOf(e)) e = Ct(null, e, t, n, r), yt.push(e); else {
            var a = Zt(e, t, n, r);
    ...
    }, Br = null, $r = null, Vr = null, Hr = !1;
    function qr(e, t) {
        var n = t.window === t ? t.document : 9 === t.nodeType ? t : t.ownerDocument;
        return Hr || null == Br || Br !== sn(n) ? null : ("selectionStart" in (n = Br) && gn(n) ? n = {
    ...
    function Va(e) {
        return null === Ma ? (Ma = [ e ], Ra = xa(Ta, qa)) : Ma.push(e), Na;
    }
    function Ha() {
        if (null !== Ra) {
            var e = Ra;
    ...
    function qa() {
        if (!za && null !== Ma) {
            ...
            try {
                ...
                throw null !== Ma && (Ma = Ma.slice(e + 1)), xa(Ta, Ha), t;
            } finally {
                za = !1;
            }
        }
    ...
    var Fo = Y.ReactCurrentDispatcher, Uo = Y.ReactCurrentBatchConfig, Wo = 0, Bo = null, $o = null, Vo = null, Ho = !1;
    function qo() {
        throw Error(i(321));
    }
    function Ko(e, t) {
    ...
    function hi(e, t, n) {
        ...
        e === Bo || null !== o && o === Bo) Ho = !0, a.expirationTime = Wo, Bo.expirationTime = Wo; else {
    ...
    var ml, bl = Math.ceil, vl = Y.ReactCurrentDispatcher, yl = Y.ReactCurrentOwner, wl = 0, kl = 3, xl = 4, El = 0, _l = null, Sl = null, Ol = 0, Tl = wl, Cl = null, Pl = 1073741823, jl = 1073741823, Il = null, Nl = 0, Al = !1, Dl = 0, Ml = null, Rl = !1, zl = null, Ll = null, Fl = !1, Ul = null, Wl = 90, Bl = null, $l = 0, Vl = null, Hl = 0;
    function ql() {
    ...
    function ru(e, t) {
        for (;;) {
            try {
                if (Ja(), Fo.current = mi, Ho) for (var n = Bo.memoizedState; null !== n; ) {
                    var r = n.queue;
                    null !== r && (r.pending = null), n = n.next;
                }
                if (Wo = 0, Vo = $o = Bo = null, Ho = !1, null === Sl || null === Sl.return) return Tl = 1, 
                Cl = t, Sl = null;
                e: {
    ...
    function pu(e, t) {
        ...
        a = n.firstEffect) : a = n : a = n.firstEffect, null !== a) {
            ...
            qt = !!hn, mn = hn = null, e.current = n, Ml = a;
            do {
                try {
                    for (w = e; null !== Ml; ) {
                        var E = Ml.effectTag;
